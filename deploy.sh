...
aws lambda --region us-east-1 update-function-configuration --function-name version-surrealdb-com --runtime nodejs14.x --handler index.main --timeout 5 --memory-size 128 && sleep 3
